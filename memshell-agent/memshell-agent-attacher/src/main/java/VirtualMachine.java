 ...
 * machine interface to allow for similar usage by where all calls are made via
...
public interface VirtualMachine {
    ...
    enum Resolver {
         ...
         * {@inheritDoc}
         */
        public Class<? extends VirtualMachine> get() {
            try {
        ...
        public interface Dispatcher {
            ...
            class ForJnaWindowsEnvironment implements Dispatcher {
                ...
                protected interface WindowsLibrary extends StdCallLibrary {
                    ...
                    @SuppressWarnings("checkstyle:methodname")
                    WinNT.HANDLE CreateSemaphoreW(WinBase.SECURITY_ATTRIBUTES securityAttributes,
                                                  long count,
                                                  long maximumCount,
                                                  String name);
